...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return ((self.startingPosition, (0, 0, 0, 0))) #no corner has been reached
    ...
    def isGoalState(self, state):
        ...
        for value in state[1]:
            if value == 0: return False #if some corner has not been reached, return False
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                successors.append( ((nextPosition, tuple(nextVisited)), action, cost) )
...
def cornersHeuristic(state, problem):
    ...
    best = 0 #h(s) is the maximum manhattanDistance from current position to any of unvisited corners
    for i, corner in enumerate(visited):
        if corner == 0: best = max(best, util.manhattanDistance(position, corners[i]))
